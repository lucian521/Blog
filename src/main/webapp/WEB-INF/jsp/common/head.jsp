...
<link rel="icon" href="${g.domain}/resource/img/favicon.png" type="image/x-icon" />
...
<link rel="stylesheet" href="${g.domain}/resource/css/lanrenzhijia.css" type="text/css">
<script src="${g.domain}/resource/js/lanrenzhijia.js"></script>
<!--[if IE 6]>
